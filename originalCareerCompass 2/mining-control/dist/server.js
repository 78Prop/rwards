...
const miningPools = [
    ...
    },
    {
        ...
        url: 'stratum+tcp://0.0.0.0:4444',
        status: 'connected',
        hashRate: 490,
        address: 'bc1qj93mnxgm0xuwyh3jvvqurjxjyq8uktg4y0sad6', // Using the same wallet for all pools
        username: 'Kloudbugs7',
        managed: true,
        fees: 0.5,
        connectedRigs: 4
...
app.get('/', (req, res) => {
    ...
    <body>
        ...
        <script>
            ...
            const ws = new WebSocket('ws://0.0.0.0:5000/mining-ws');
